        ...
        <div class="row text-center text-md-start justify-content-between">
            ...
            <div class="col-md-2 col-sm-6 mb-4 small">
                ...
                <ul class="list-unstyled mb-3">
                    ...
                    <li><a href="https://maps.app.goo.gl/YW1pFB4cYMnwVbay6" target="_blank" class="text-decoration-none text-light opacity-75"><i class="bi bi-geo-alt me-2"></i>Av. Las Heras 727, Corrientes</a></li>
                </ul>
            </div>
            {{-- Tèrminos y Legales --}}
            <div class="col-md-2 col-sm-6 mb-4 small">
